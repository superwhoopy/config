...
; Mattermost
RunWait('komorebic.exe identify-border-overflow-application exe "Mattermost.exe"', , "Hide")
RunWait('komorebic.exe identify-tray-application exe "Mattermost.exe"', , "Hide")
